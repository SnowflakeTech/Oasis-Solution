...
public class Test {
    public static void main(String[] args) {
        Person pts = new Person("Phạm Tiến Sơn", "11/11/2004", "Male", "PTS");
        Person p1 = new Person("P1", "01/01/2025", "Female", null);
        Person p2 = new Person("P2", "01/01/2025", "Male", "s1");
        pts.addChild(p1);
        pts.addChild(p2);
        
        Person ps1 = new Person("PS1", "02/02/2028", "Female", null);
        Person ps2 = new Person("PS2", "02/02/2025", "Male", "v1");
        p2.addChild(ps1);
        p2.addChild(ps2);
